...
class LiveChaptersRvAdapter (private val list: List<String>):
    RecyclerView.Adapter<LiveChaptersRvAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LiveChaptersRvAdapter.ViewHolder {
        val binding =
